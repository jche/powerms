...
#include "stanExports_normal_mlm_centered.h"

RCPP_MODULE(stan_fit4normal_mlm_centered_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_normal_mlm_centered")
